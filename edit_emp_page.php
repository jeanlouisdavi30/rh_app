...
require "includes/form_handlers/update_emp_handler.php";
    ...
    <div class="containerFormPage">
        ...
        <?php 
            if( $_SESSION['utype'] == 'admin'){
                echo "<center><a href='admin_dash.php' class='btn btn-warning btn-sm'> Retourner au panneau d'administration </a></center> <br><p> ";
            }
        ?>
            <h3  class="formulaireTitle">Informations personnelles</h3>
        
        <form id="login" action="edit_emp_page.php" method="POST">

            <div class="form-group">
                <label for="nom">Nom de famille</label>
                <input type="text" class="form-control" id="nom" name="emp_lastname" value="<?php if(isset($_SESSION['emp_lastname'])) echo $_SESSION['emp_lastname']; ?>">
            </div>
            <div class="form-group">
                <label for="prenom">Prénom</label>
                <input type="text" class="form-control" id="prenom" name="emp_firstname" value="<?php if(isset($_SESSION['emp_firstname'])) echo $_SESSION['emp_firstname']; ?>">
            </div>
            <div class="form-group">
                <label for="sexe">Sexe</label>
                <select class="form-control" id="sexe" name="emp_sexe" value="<?php if(isset($_SESSION['emp_sexe'])) echo $_SESSION['emp_sexe']; ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nif" name="emp_nif" value="<?php if(isset($_SESSION['emp_nif'])) echo $_SESSION['emp_nif']; ?>">
            </div>
            
            <div class="form-group">
                <label for="emp_birthdate">Date de naissance</label>
                <input type="date" class="form-control" id="emp_birthdate" name="emp_birthdate" value="<?php if(isset($_SESSION['emp_birthdate'])) echo $_SESSION['emp_birthdate']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="telephone" name="emp_phone" value="<?php if(isset($_SESSION['emp_phone'])) echo $_SESSION['emp_phone']; ?>">
            </div>
            <div class="form-group">
                <label for="address1">Adresse 1</label>
                <input type="text" class="form-control" id="adresse1" name="emp_address1" value="<?php if(isset($_SESSION['emp_address1'])) echo $_SESSION['emp_address1']; ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="emp_nbr_enfant" name="emp_nbr_child" value="<?php if(isset($_SESSION['emp_nbr_child'])) echo $_SESSION['emp_nbr_child']; ?>">
            </div>
            <div class="form-group">
           ...
           <div class="text-center">
            <button type="submit" class="btn btn-warning" name="emp_button">Enregistrer</button>
           </div>
        </form>
