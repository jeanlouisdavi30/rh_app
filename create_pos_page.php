...
require "includes/form_handlers/register_pos_handler.php";
...
<body>
   ...
   <?php include_once('entete_admin.php'); ?>
    ...
    <div class="containerFormPage">
        ...
        <form id="login" action="create_pos_page.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="pos_supervisor" name="pos_supervisor">
            </div>
            <div class="form-group">
                <label for="phone">Départment</label>
                <input type="text" class="form-control" id="pos_department" name="pos_department">
            </div>
            <div class="form-group">
                <label for="phone">date d'embauche</label>
                <input type="date" class="form-control" id="date_emp" name="date_emp" >
            </div>
            <div class="form-group">
                <label for="prenom">Description</label>
                <textarea id="pos_description" class="form-control" rows="4" cols="50" name="pos_description">
