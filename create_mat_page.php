...
require "includes/form_handlers/register_mat_handler.php";
...
<body>
   ...
   <?php include_once('entete_admin.php'); ?>
    ...
    <div class="containerFormPage">
            <h3  class="formulaireTitle">Nouvelle affectation de matériel</h3>

        
        <form id="login" action="create_mat_page.php" method="POST">
            <div class="form-group">
                <input type="hidden" class="form-control" id="emp_id" name="emp_id" value="<?php if(isset($_GET['emp_id'])) echo $_GET['emp_id']; ?>">
            </div>
            <div class="form-group">
                <label for="nom">Matériel</label>
                <input type="text" class="form-control" id="materiel" name="materiel" value="<?php if(isset($_SESSION['materiel'])) echo $_SESSION['materiel']; ?>">
            </div>
            <div class="form-group">
                <label for="prenom">Identifiant</label>
                <input type="text" class="form-control" id="identifiant" name="identifiant" value="<?php if(isset($_SESSION['identifiant'])) echo $_SESSION['identifiant']; ?>">
            </div>
            <div class="form-group">
                <label for="emp_birthdate">Date de sortie</label>
                <input type="date" class="form-control" id="date_sortie" name="date_sortie" value="<?php if(isset($_SESSION['date_sortie'])) echo $_SESSION['date_sortie']; ?>">
            </div>
            <div class="form-group">
                <label for="etatMatrimonial">Statut</label>
                <select class="form-control" id="mat_statut" name="mat_statut" value="<?php if(isset($_SESSION['mat_statut'])) echo $_SESSION['mat_statut']; ?>">
                    <option>LIVRE</option>
            ...
            <div class="form-group">
                ...
                <input type="date" class="form-control" id="date_entree" name="date_entree" value="<?php if(isset($_SESSION['date_entree'])) echo $_SESSION['date_entree']; ?>">
            </div>
            <div class="form-group">
                <label for="livre_par">Livrée par</label>
                <input type="text" class="form-control" id="livre_par" name="livre_par" value="<?php if(isset($_SESSION['livre_par'])) echo $_SESSION['livre_par']; ?>">
            </div>
            <div class="form-group">
                <label for="comment">Commentaires</label>
                <input type="text" class="form-control" id="comment" name="comment" value="<?php if(isset($_SESSION['comment'])) echo $_SESSION['comment']; ?>">
            </div>
