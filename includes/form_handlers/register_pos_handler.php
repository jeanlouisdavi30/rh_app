...
$timezone = date_default_timezone_set("America/New_York");
    ...
    if(isset($_GET['emp_id'] )){
      ...
      if ($result->num_rows > 0) {
        ...
        header("Location: edit_pos_page.php?emp_id=" . $emp_id);
        exit();
...
*/
  ...
  if(empty($error_array)){
   ...
   $query = "INSERT INTO `job` VALUES (NULL, '$emp_id', '$pos_name', '$description', '$supervisor', '$department', '$date_emp', '$created', '$updated')";
/*
    $created = date("Y-m-d H:i:s");
    $updated = date("Y-m-d H:i:s");
...
*/
   ...
   if (mysqli_query($con, $query)) {
    ...
    // envoie de l'email de confirmation a l'email ocinewdescrit
      ...
      echo "Poste registered successfully";
